...
//UML DESCRIPTION
// For our architecture and design, they both revolved around a system where users could interact with the help system. To implement
// this design via code, this system makes the actual users and their account details so that they are able to interact with the system.
// All of their information is initialized here and can be updated as roles, passwords, are changed to maintain robustness.
public class User {
