...
//UML DESCRIPTION
// As mentioned in the EncryptionHelper Class, security and privacy has always been our number one priority in our design. This
// class provides methods for the encryption algorithm to use so that user and help article data can be properly
// secured to maintain a safe system overall.
